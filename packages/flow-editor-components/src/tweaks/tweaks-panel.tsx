...
// individual pages don't re-roll it. Ships a consistent set of controls so you
...
export function TweaksPanel({ title = 'Tweaks', closeLabel = 'Close', noDeckControls = false, children }) {
...
export function TweakText({ label, value, placeholder, onChange }) {
  return (
    <TweakRow label={label}>
      <EchoInput className="twk-field" type="text" value={value} placeholder={placeholder}
