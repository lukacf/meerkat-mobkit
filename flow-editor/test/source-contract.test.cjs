...
assert.match(inspectorTerminalBlock, /const result = studio\.deleteInstance\(inst\.id\); clearSelection\(result\?\.selection\);/, "Terminal inspector deletes must apply controller-projected selection clearing");
assert.match(inspectorInstanceBlock, /const result = studio\.deleteInstance\(inst\.id\); clearSelection\(result\?\.selection\);/, "Instance inspector deletes must apply controller-projected selection clearing");
assert.match(inspectorEdgeBlock, /const result = studio\.deleteEdge\(edge\.id\); clearSelection\(result\?\.selection\);/, "Edge inspector deletes must apply controller-projected selection clearing");
