...
assert.match(builder, /applyAuthoringReplacement\(\{[\s\S]*flow:\s*result\.flow,[\s\S]*studio:\s*\{\s*edges:\s*result\.edges\s*\}/, "Basic input-param cascades must submit graph condition-edge changes through MobKit replacement");
