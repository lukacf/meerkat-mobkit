...
assert.match(mobpackRust, /pub struct MobpackRuntimeCatalogState \{[\s\S]*runtime_flow_rows: Vec<Value>/, "MobKit runtime catalog state must carry projected runtime flow rows for the Flow Editor registry");
