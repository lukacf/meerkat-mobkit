...
assert.match(mobpackRust, /"reconcile_contract_refs"\s*=>\s*apply_reconcile_contract_refs_operation/, "MobKit apply_operation must own contract-ref reconciliation");
