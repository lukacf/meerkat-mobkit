...
assert.match(controller, /async function applyAuthoringOperationDocument\(document,\s*operation,\s*options = \{\}\)[\s\S]*rpcMethod\("applyOperation"\)/, "controller plane must apply editor mutations through mobkit/mobpacks/apply_operation");
