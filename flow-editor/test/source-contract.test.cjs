...
assert(!/agents-list__item\" \+|agents-list__placed\" \+|row\.role\} · \{row\.model|row\.fieldLabel\} · \{row\.usageLabel|agents unavailable|MobKit schema contract has not provided agent definitions yet/.test(agentsListBlock + "\n" + addAgentControlBlock), "Agent sidebar JSX must not compose row classes, sublabels, or add-control unavailable copy locally");
