...
#
# This used to sed exactly one file, crates/meerkat-mobkit/BUILD.bazel, which made it a
# hand-maintained enumeration of a generated artifact. It silently missed
# crates/mobkit-store-conformance/BUILD.bazel, so that file drifted one release behind
