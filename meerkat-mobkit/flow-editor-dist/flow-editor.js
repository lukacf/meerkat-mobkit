...
const {
  ...
  dispatchFromFork,
  dispatchModeAllowed,
  dispatchModeFromStepSource,
  dispatchModeOptions,
  edgeConditionToEditorCond,
  edgesForDocument,
  editorCondToGraphCond,
  ...
  graphControlDependsMode,
  graphControlNodes,
  graphDraftLabelEquals,
  graphDragCellAt,
  ...
  graphIsConditionEdge,
  graphIsFallbackBranchLane,
