...
fn runtime_for_gating() -> meerkat_mobkit::MobkitRuntimeHandle {
    start_mobkit_runtime(
        MobKitConfig {
            modules: vec![],
...
fn runtime_for_gating_with_routing_delivery() -> meerkat_mobkit::MobkitRuntimeHandle {
...
fn runtime_for_gating_with_forced_failed_delivery() -> meerkat_mobkit::MobkitRuntimeHandle {
    let fixture_binary = fixture_binary_path();
    start_mobkit_runtime(
        MobKitConfig {
            modules: vec![
