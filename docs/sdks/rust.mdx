...
The Rust crate `meerkat-mobkit-core` is the primary interface for MobKit. All other interfaces (JSON-RPC, SDKs, console) are built on top of it.
...
// Interaction SSE
let sse: Router = interaction_sse_router(mob_runtime);
```
